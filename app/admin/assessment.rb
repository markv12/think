ActiveAdmin.register Assessment do
  permit_params :name, questions_attributes: [:id, :assessment_id, :question_type, :question_text, :scale_min, :scale_max, :_destroy, category_ids: []]
  ...
  form do |f|
    f.inputs "Assessment Information" do
      ...
      f.has_many :questions, :heading => 'Questions' do |qf|
        ...
        qf.input :categories,:as => :select, :input_html => {:multiple => true}
